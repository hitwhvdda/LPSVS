...
def train_and_save(hidden_size,fc1_size,lr,dropout1,batch_size,max_epoch=100):
    config={}
    ...
    data = CCSDatasetDataModule(CCSDataset,config)
    logger=TensorBoardLogger(save_dir="/home/ao_ding/expand/D2A/result", name="CodeBERT_Transformer_MEAN4", version=".")
...
if __name__=='__main__':
    ...
    train_and_save(2048,256,0.000005,0.3,32)
