...
import os
import sqlite3
from pl_model import Codebert_BiLSTM,Codebert_BGRU,Codebert_CNN,Codebert_BRNN,Codebert_Transformer
...
max_length = 41
def initdb():
    conn = sqlite3.connect(r'/home/ao_ding/expand/D2A/database/CodeBERT_Transformer_MEAN4.db')
    c = conn.cursor()
...
def generate_signature(PATH=""):
    ...
    if(os.path.exists(r"/home/ao_ding/expand/D2A/database/CodeBERT_Transformer_MEAN4.db")!=True):
        initdb()
