...
class CCSDataset:
    ...
    def __init__(self, partition="train", max_length=575):
        """Init."""
...
class CCSDatasetDataModule(pl.LightningDataModule):
    ...
    def __init__(self, DataClass, batch_size):
        ...
        super().__init__()
        self.train = DataClass(partition="train",max_length=575)
        self.val = DataClass(partition="val",max_length=575)
        self.test = DataClass(partition="test",max_length=575)
...
if __name__=='__main__':
    PATH="/home/ao_ding/gwork/saved/logger_200/checkpoints/sample-epoch=08-val_acc=1.00-v1.ckpt"
    config={}
    batch_size=64
