...
def train_and_save(hidden_size,fc1_size,lr,dropout1,batch_size,max_epoch=20):
    ...
    print(config)
    model = Codebert_BRNN(config).to(0)
    data = CCSDatasetDataModule(CCSDataset,config)
    logger=TensorBoardLogger(save_dir="/home/ao_ding/expand/trace/result", name="Codebert_BRNN_MEAN", version=".")
...
if __name__=='__main__':
    ...
    train_and_save(384,256,0.0001,0.3,64)
