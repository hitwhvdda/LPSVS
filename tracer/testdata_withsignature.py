...
def selectforlist():
    conn = sqlite3.connect('/home/ao_ding/expand/trace/database/signature_CodeBERT_BRNN_MEAN.db')
...
def compare(output):
    ...
    if(signature_source[0:3]=='CWE'):
        signature_source=signature_source.split('_')[0]
...
if __name__ == "__main__":
    ...
    PATH="/home/ao_ding/expand/trace/result/Codebert_BRNN_MEAN/checkpoints/sample-epoch=19-val_acc=1.00.ckpt"
