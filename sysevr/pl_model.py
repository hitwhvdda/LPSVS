...
class CCSDataset:
    ...
    def __getitem__(self, idx):
        ...
        #     print("context_embedding:",context_embeddings.size())
        ...
        for a_sentense in sentense:
            ...
            self.embedding = torch.cat([self.embedding,context_embeddings],dim=1)
        #print("embedding:",self.embedding.size())
...
def train_and_save(hidden_size,fc1_size,lr,dropout1,batch_size,max_epoch=20):
    ...
    print(config)
    model = Codebert_Transformer(config).to(0)
    data = CCSDatasetDataModule(CCSDataset,config)
    logger=TensorBoardLogger(save_dir="/home/ao_ding/expand/SySeVR/result", name="Codebert_Transformer_MEAN", version=".")
...
if __name__=='__main__':
    ...
    train_and_save(2048,256,0.0001,0.3,64)
