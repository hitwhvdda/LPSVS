...
def initdb():
    conn = sqlite3.connect(r'/home/ao_ding/expand/SySeVR/database/signature_fasttext_bgru.db')
    c = conn.cursor()
...
def generate_signature(PATH=""):
   ...
   #exit()
    ...
    if(os.path.exists(r"/home/ao_ding/expand/SySeVR/database/signature_fasttext_bgru.db")!=True):
        initdb()
