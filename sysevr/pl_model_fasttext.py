...
class FastText_BGRU(pl.LightningModule):
    """model."""
...
def train_and_save(hidden_size,fc1_size,lr,dropout1,batch_size,max_epoch=20):
    ...
    model = FastText_BGRU(config).to(0)
    data = CCSDatasetDataModule(CCSDataset,config)
    logger=TensorBoardLogger(save_dir="/home/ao_ding/expand/SySeVR/result", name="FastText_BGRU", version=".")
...
if __name__=='__main__':
    ...
    train_and_save(386,128,0.0001,0.3,64)
