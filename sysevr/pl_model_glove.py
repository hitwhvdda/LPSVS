...
class Glove_BGRU(pl.LightningModule):
    """model."""
...
def train_and_save(hidden_size,fc1_size,lr,dropout1,batch_size,max_epoch=20):
    ...
    model = Glove_BGRU(config).to(0)
    data = CCSDatasetDataModule(CCSDataset,config)
    logger=TensorBoardLogger(save_dir="/home/ao_ding/expand/SySeVR/result", name="Glove_BGRU", version=".")
